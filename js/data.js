var equipmentsData = [
  {type: "equipment", name: "Boom", layer: 1, url: "images/sample_1.png", x: 10, y: 280, width: 360, length: 100, anchors: [
    {layer: 1, x: 8, y: 92, radius: 4},
    {layer: 1, x: 185, y: 16, radius: 4},
    {layer: 1, x: 138, y: 8, radius: 4},
    {layer: 1, x: 353, y: 92, radius: 4}
  ], grade: 2,
   youtube: "http://www.youtube.com/watch?v=u6QIpXca9D4",
   wikipedia: "http://en.wikipedia.org/wiki/Backhoe"
  },
  {type: "equipment", name: "Stick", layer: 1, url: "images/sample_2.png", x: 180, y: 430, width: 217, length: 65, anchors: [
    {layer: 1, x: 7, y: 57, radius: 4},
    {layer: 1, x: 31, y: 54, radius: 4},
    {layer: 1, x: 161, y: 54, radius: 4},
    {layer: 1, x: 210, y: 33, radius: 4},
    {layer: 1, x: 155, y: 8, radius: 4}
  ], grade: 3,
   youtube: "http://www.youtube.com/watch?v=u6QIpXca9D4",
   wikipedia: "http://en.wikipedia.org/wiki/Backhoe"
  },
  ...
  {type: "equipment", name: "Bucket", layer: 1, url: "images/sample_5.png", x: 10, y: 420, width: 80, length:90, anchors: [
    {layer: 1, x: 28, y: 82, radius: 4},
    {layer: 1, x: 50, y: 78, radius: 4},
    {layer: 1, x: 80, y: 40, radius: 4}
  ], grade: 4,
   youtube: "http://youtu.be/MCc6eK56afw",
   wikipedia: "http://en.wikipedia.org/wiki/Bucket_%28machine_component%29"
  },
  {type: "equipment", name: "Upper-Carriage", layer: 1, url: "images/sample_6.png", x: 240, y: 520, width: 250, length: 115, anchors: [
    {layer: 1, x: 65, y: 95, radius: 5, opacity: 0.5},
    {layer: 1, x: 100, y: 85, radius: 5, opacity: 0.5},
    {layer: 1, x: 90, y: 115, radius: 5, opacity: 0.5}
  ], slots: [
